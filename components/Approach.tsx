    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="By mapping out clear objectives and crafting actionable steps, we pave the way for sustained growth and innovation."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="By consistently monitoring advancements and addressing challenges, we drive continuous improvement and achieve our goals."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="By nurturing ideas through strategic growth and orchestrating a seamless launch, we bring visions to life and captivate audiences."
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div>
      <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
        ...
        <div className="relative flex font-bold space-x-2 items-center z-10 rounded-full bg-zinc-950 py-2 px-5 ring-1 ring-white/10 text-2xl">
          <span>{order}</span>
        </div>
      </button>
    </div>
