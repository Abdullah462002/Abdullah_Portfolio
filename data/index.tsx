...
export const gridItems = [
...

  {
    id: 5,
    title:
      'Exploring the intersection of technology and art through creative coding.',
...
export const projects = [
  {
    ...
    link: 'https://github.com/Abdullah462002/PharmaAssistant.git',
  },
  {
    id: 2,
...
export const workExperience = [
  {
    ...
    desc: 'Working in the development of a web application using Java, Spring and PrimeFaces.',
  ...
  },
  {
    ...
    desc: 'DMI College Of Engineering.',
    className: 'md:col-span-2',
    thumbnail: '/exp2.svg',
  },
  // {
